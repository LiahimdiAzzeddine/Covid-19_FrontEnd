...
class _DetailsScreenState extends State<DetailsScreen> {
  ...
  Future ajouter() async {
    ...
    notifToken="cIYh2AhvTEmsa807rMXQrs:APA91bFd1tiNLQvtsZ08IUrNdqEGljGxxtGxEMm6O2yEVqa7TZokjQbOI8ksk-1_TKOrpIRbiovefRhPJ-vTX-P7NtaYwQAPpuoFC0RZACS6XXdGyh21jRvnLhFLJdE_CdygkPklPfKX";
  }
  Future<void> _sendData(token) async {
    ...
    try {
      var response = await client.post(
          Uri.parse('http://192.168.1.9:8000/api/v1/positif'),
